...
const addPolygonLines = (polygonPoints, outLines) => {
...
export function fillManhCellsLines(manh, innerCellRadiusMargin , outLines) {
    manh.forEach(mi => {
        ...
        addPolygonLines(mi.polygonPoints, outLines);
        addPolygonLines(innerPoly, outLines);
        addPolygonLines(innerPoly2, outLines);
        addPolygonLines(innerPoly3, outLines);
    });
};
